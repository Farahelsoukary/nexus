                ...
                <MDBCardBody>
                    <MDBRow>
                        ...
                        <MDBCol md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
                            <h1  className="text-center" style={{color: "#fd4930", fontSize: "40px", fontWeight: 700, marginBottom: "10px"}}>Login</h1>
                            ...
                            <div className="mb-3">
                                <label htmlFor="exampleInputPassword1" className="form-label" style={{color: "#263238", fontSize: "18px" , textAlign: "left", marginBottom: "8px"}}>Password:</label>
                            ...
                            <Button color="#0d6efd" className="btn btn-success" size='fixed' disabled={errorData.userEmailerror || errorData.userPassworderror} style={{ marginTop: "5px", color: "white", backgroundColor: "#fd4930", width: "400px", fontSize: "18px", margin: "auto"}}>Login</Button>
                            <p style={{color: "#263238",  marginTop: "5px"}} className="text-center">Don't have an account?</p>
                            <Link  className="text-center" to={`/signup`} style={{ marginTop: "0px", color: "#fd4930",  fontSize: "16px"}}>Sign up</Link>
                        </MDBCol>
                        <MDBCol md='10' lg='6' className='order-1 order-lg-2 d-flex align-items-center'>
                            <MDBCardImage src='https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-registration/draw1.webp' fluid style={{ marginLeft: "15%",width: '80%', height: '65%' }} />
                        </MDBCol>
                    </MDBRow>
                </MDBCardBody>
            </MDBCard>
