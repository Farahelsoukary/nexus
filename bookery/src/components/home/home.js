...
function SearchPage() {
    ...
    return (<>
        <div className="background" style={{textAlign: "center"}}>
            <h2 className='header-title text-capitalize'>Find a book of your choice.</h2>
            <p className='header-text '>Welcome to our Bookstore where the enchanting world of literature meets the convenience of online shopping! Immerse yourself in a virtual realm of captivating stories, timeless classics, and the latest literary treasures—all at your fingertips.
